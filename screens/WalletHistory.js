...
export default WalletHistory = ({navigation}) => {
  ...
  const getData = async () => {
    ...
    if (!loading && !isListEnd) {
      ...
      fetch('https://customerapp.toniapharmacy.com.ng/dev/api/authentication/get_walletReport?user_id='+user_id+'&&offset='+offset)
  ...
  return (
   ...
   <View style={styles.header}>
            <Text style={styles.headertext}>Wallet History</Text>
        </View>
      <FlatList
        style={styles.box1}
        data={dataSource}
